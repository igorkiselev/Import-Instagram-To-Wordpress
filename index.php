...
add_action( 'plugins_loaded', function(){
	...
	function _option_field( $t =  null, $type = 'html', $p =  null, $c = null, $n = null, $d = null, $v = null){
		...
		if($type == 'html'){
			$result .= __($t);
			}else if($type == 'field' || $type == 'checkbox'){
	...
	function _options_page(){
		global $oauth;
		if (!current_user_can('manage_options')){ wp_die( __('You do not have sufficient permissions to access this page.','instagram') );}
